package com.resto.api.exception.handler;
...
import com.resto.exception.AlreadyExistsException;
import com.resto.exception.DataNotFoundException;
import com.resto.exception.ElementNotFoundException;
import com.resto.exception.InvalidDateException;
import com.resto.exception.ServiceException;
import com.resto.exception.UserTypeMisMatchException;
...
import com.resto.repository.exception.DuplicateEntryException;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	private static ValidationError buildErrorList(List<Reference> list) {
        ...
        for (Reference fieldError : list) {
            error.addError(new com.resto.model.message.Error(fieldError.getFieldName(), "Expected integer"));
        }
        return error;
    }
}